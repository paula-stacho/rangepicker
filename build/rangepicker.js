...
(function ($) {
    ...
    $.fn.rangepicker = function (options) {
        ...
        options = $.extend({
            ...
            months: 3,
            lastMonthDisplayed: (0, _moment2.default)().format('YYYY-MM'),
            defaultStart: (0, _moment2.default)().subtract(6, 'days').format('YYYY-MM-DD'),
            defaultEnd: (0, _moment2.default)().format('YYYY-MM-DD'),
            defaultCompareStart: (0, _moment2.default)().subtract(13, 'days').format('YYYY-MM-DD'),
            defaultCompareEnd: (0, _moment2.default)().subtract(7, 'days').format('YYYY-MM-DD'),
