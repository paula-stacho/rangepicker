...
(function ($) {
    ...
    $.fn.rangepicker = function (options) {
        ...
        function makeForm() {
            ...
            dateFrom = $('<div class="rp-date-input">' + ('<input class="rp-input-mini rp-input-interval focus" type="date" name="range-start" value="' + startFormatted + '">') + '</div> - ');
            dateTo = $('<div class="rp-date-input">' + ('<input class="rp-input-mini rp-input-interval" type="date" name="range-end" value="' + endFormatted + '">') + '</div>');
            ...
            compareDateFrom = $('<div class="rp-date-input">' + ('<input class="rp-input-mini rp-input-compare" type="date" name="compare-range-start" value="' + compareStartFormatted + '">') + '</div> - ');
            compareDateTo = $('<div class="rp-date-input">' + ('<input class="rp-input-mini rp-input-compare" type="date" name="compare-range-end" value="' + compareEndFormatted + '">') + '</div>');
