...
(function ($) {
    ...
    $.fn.rangepicker = function (options) {
        ...
        function makeForm() {
            ...
            dateFrom = $('<div class="rp-date-input">' + ('<input class="rp-input-mini" type="date" name="range-start" value="' + startFormatted + '">') + '</div> - ');
            dateTo = $('<div class="rp-date-input">' + ('<input class="rp-input-mini" type="date" name="range-end" value="' + endFormatted + '">') + '</div>');
            ...
            var compareDateRanges = $('<div>\n                    <label for="rp-comparerange-preset">Compare to period:</label>  \n                </div>');
            compareDateRanges.prepend(showCompare).append(compareRangeOptions);
            compareDateFrom = $('<div class="rp-date-input">' + '<input class="rp-input-mini" type="date" name="compare-range-start" value="">' + '</div> - ');
            compareDateTo = $('<div class="rp-date-input">' + '<input class="rp-input-mini" type="date" name="compare-range-end" value="">' + '</div>');
        ...
        function prepareOutputs() {
            ...
            outputsCompare.prepend(outputCompareFrom).append(outputCompareTo).hide();
